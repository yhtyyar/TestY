...
LIST_VIEW_NAMES = {
    'project': 'api:v2:project-list',
    'test': 'api:v2:test-list',
    'plan': 'api:v2:testplan-list',
    'result': 'api:v2:testresult-list',
    'suite': 'api:v2:testsuite-list',
    'case': 'api:v2:testcase-list',
    'user': 'api:v2:user-list',
    'parameter': 'api:v2:parameter-list',
    'status': 'api:v2:status-list',
}
DETAIL_VIEW_NAMES = {
    'project': 'api:v2:project-detail',
    'test': 'api:v2:test-detail',
    'plan': 'api:v2:testplan-detail',
    'result': 'api:v2:testresult-detail',
    'suite': 'api:v2:testsuite-detail',
    'case': 'api:v2:testcase-detail',
    'user': 'api:v2:user-detail',
